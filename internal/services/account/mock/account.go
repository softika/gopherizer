...
//
//	mockgen -source=account.go -destination=./mock/account.go -package=mock
//
...
func (m *MockRepository) Create(ctx context.Context, account *model.Account) (*model.Account, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Create(ctx, account any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
