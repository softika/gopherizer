...
func (m *MockRepository) GetByEmail(arg0 context.Context, arg1 string) (*model.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 *model.User) (*model.User, error) {
	m.ctrl.T.Helper()
