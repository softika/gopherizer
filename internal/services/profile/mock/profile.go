...
//
//	mockgen -source=profile.go -destination=./mock/profile.go -package=mock
//
...
func (m *MockRepository) Create(arg0 context.Context, arg1 *model.Profile) (*model.Profile, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetById(arg0 context.Context, arg1 string) (*model.Profile, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 *model.Profile) (*model.Profile, error) {
	m.ctrl.T.Helper()
